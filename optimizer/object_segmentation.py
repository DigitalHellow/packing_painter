"""
Helper functions to remove background from a given photo
to be used by the packing optimizer.
The parameters will need to be adjusted from image
to image, but the algorithms execution is rather quick. 
"""
